    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/pavel/Desktop/IVS/assignment/out/build/x64-Debug (default)/googletest-master'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/pavel/Desktop/IVS/assignment/out/build/x64-Debug (default)/googletest-master'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
